...
Production için Cloudflare tarafında `GAME_KV` isminde bir KV namespace oluşturmalı ve ID'sini `wrangler.toml` içerisine girmelisiniz. Ayrıca `wrangler secret put` komutuyla secret verilerini yapılandırmalısınız.
